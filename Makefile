...
compile_drivers:
	...
	$(CC) -g -Os -nostdinc -isystem $(SYS_INCLUDE) -I/home/hao/jorjin_bsp/kernel/android-3.4/arch/arm/include -I./ -Iinclude  -include /home/hao/jorjin_bsp/kernel/android-3.4/include/linux/kconfig.h -DDEBUG -D__KERNEL__ -mlittle-endian -D__ASSEMBLY__ -mabi=apcs-gnu -mno-thumb-interwork  -D__LINUX_ARM_ARCH__=7 -march=armv7-a  -include asm/unified.h -msoft-float -gdwarf-2 -Wa,-march=all -DTEXT_OFFSET=0x00008000 -c -o drivers/t_head.o drivers/t_head.S
linker: compile_start compile_drivers
	$(LD) -EL -p --no-undefined -X --build-id -o t_kernel start.o drivers/t_head.o drivers/serial_port.o drivers/delay.o -T linkerscript -Map t_kernel.map
binary: linker
